                    ...
                    <div class="elementor-widget-container">
                        ...
                        <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                            <div class="imageautoplay" aria-live="off">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/11.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/22.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/33.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/44.jpg') }}" alt="3.jpg" /></figure>
                            </div>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-image-carousel-wrapper swiper">
                            <div class="imageautoplay">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/333.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/444.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/111.jpg') }}" alt="3.jpg" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/fourdress/222.jpg') }}" alt="3.jpg" /></figure>
                            </div>
                    ...
                    <div class="elementor-element elementor-element-69ca886 elementor-widget__width-initial elementor-widget elementor-widget-video"
                        ...
                        <div class="elementor-widget-container">
                            ...
                            <div class="elementor-wrapper elementor-open-inline">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/nUZvCmsuur4?si=9_5eIoMaEWG6lcZy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="wcf-embed-checkout-form"
                                ...
                                <div class="woocommerce">
                                    ...
                                    <form action="{{ route('landing.order.store') }}" method="POST">
                                        ...
                                        <input type="hidden" name="attribute_id" value="87">
                                        <input type="hidden" name="inventory_id" value="41">
                                        ...
                                        <div  class="wcf-product-option-wrap wcf-yp-skin-classic wcf-product-option-before-customer">
                                            ...
                                            <p style="padding-top: 20px" class=" address-field form-row-first thwcfd-required thwcfd-field-wrapper thwcfd-field-text wcf-column-100 validate-required" id="billing_address_1_field" data-priority="20">
                                                    ...
                                                    <div class="woocommerce-input-wrapper" style="display: inline-flex">
                                                        <label>
                                                            <input type="checkbox" name="color[]" checked value="পেস্ট কালার" class="input-checkbox">
                                                            পেস্ট কালার
                                                        </label>
                                                        <label>
                                                            <input type="checkbox" name="color[]" value="হলুদ" class="input-checkbox">
                                                            হলুদ
                                                        </label>
                                                    </div>
                                                </p>
