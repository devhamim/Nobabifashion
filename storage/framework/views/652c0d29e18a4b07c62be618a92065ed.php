...
<head>
    ...
    <style id="custom-css" type="text/css">
        ...
        /* Color !important */[data-text-color="primary"]{color: #F8F6F8!important;}/* Background Color */[data-text-bg="primary"]{background-color: #F8F6F8;}/* Background */
        .scroll-to-bullets a,
        .featured-title,
        ...
        .single_add_to_cart_button {
            ...
            /* Color !important */[data-text-color="secondary"]{color: #F8F6F8!important;}/* Border */
            .secondary.is-outline:hover {
                border-color: #F8F6F8
            }
            ...
            /* Color !important */[data-text-color="alert"]{color: #dd3333!important;}/* Background Color */[data-text-bg="alert"]{background-color: #dd3333;}body{font-size: 100%;}body{font-family:"Lato", sans-serif}body{font-weight: 400}body{color: #2b2a2a}.nav > li > a {font-family:"Lato", sans-serif;}.nav > li > a {font-weight: 700;}h1,h2,h3,h4,h5,h6,.heading-font, .off-canvas-center .nav-sidebar.nav-vertical > li > a{font-family: "Lato", sans-serif;}h1,h2,h3,h4,h5,h6,.heading-font,.banner h1,.banner h2{font-weight: 700;}h1,h2,h3,h4,h5,h6,.heading-font{color: #555555;}.alt-font{font-family: "Dancing Script", sans-serif;}.alt-font{font-weight: 400!important;}.current .breadcrumb-step, [data-icon-label]:after, .button#place_order,.button.checkout,.checkout-button,.single_add_to_cart_button.button{background-color: #F8F6F8!important }@media screen and (min-width: 550px){.products .box-vertical .box-image{min-width: 300px!important;width: 300px!important;}}.footer-1{background-color: #e5e5e5}.footer-2{background-color: #0a0a0a}.absolute-footer, html{background-color: #F8F6F8}.label-new.menu-item > a:after{content:"New";}.label-hot.menu-item > a:after{content:"Hot";}.label-sale.menu-item > a:after{content:"Sale";}.label-popular.menu-item > a:after{content:"Popular";}
    ...
    <div class="cartflows-container">
        <div data-elementor-type="wp-post" data-elementor-id="2325" class="elementor elementor-2325"
            ...
            <div class="elementor-element elementor-element-fe03454 e-con-full e-flex e-con e-parent"
                ...
                <div class="elementor-element elementor-element-eecf8aa elementor-widget__width-initial elementor-widget elementor-widget-heading"
                        ...
                        <div class="elementor-button-wrapper">
                            <?php if($setting->first()->number_two != null): ?>
                                <a class="elementor-button elementor-button-link elementor-size-sm elementor-animation-pulse-grow"
                                    ...
                                    <span class="elementor-button-content-wrapper">
                                        <span class="elementor-button-icon elementor-align-icon-left d-flex">
                        ...
                        <div class = "wcf-el-checkout-form cartflows-elementor__checkout-form">
                            <div id="wcf-embed-checkout-form"
                                ...
                                <div class="woocommerce">
                                    ...
                                    <form action="<?php echo e(route('product.order.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
